TMP_FOLDER=$(mktemp -d)
COIN_REPO='https://github.com/olympus-protocol/ogen/releases/download/v0.2.0-beta.2/ogen-0.2.0-beta.2-linux-amd64.tar.gz'
COIN_NAME='Olympus'
COIN_DAEMON='ogen'
RED='\033[0;31m'
NC='\033[0m'
...
[Service]
ExecStart=/usr/local/bin/$COIN_DAEMON --rpc_keystore --rpc_wallet --rpc_proxy --dashboard --network testnet
Type=simple
User=root
Restart=on-failure
TimeoutStopSec=300
